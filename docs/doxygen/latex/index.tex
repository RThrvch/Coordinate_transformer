...
Это позволяет библиотеке/узлу {\ttfamily \doxylink{namespacecoordinate__transformer}{coordinate\+\_\+transformer}} проверять, находятся ли точки или позы в пределах определенных пространственных ограничений для конкретных систем координат. 